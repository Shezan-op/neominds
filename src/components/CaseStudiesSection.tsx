        ...
        <div className="space-y-10 sm:space-y-14">
          {CASE_STUDIES.map((study, idx) => (
            <motion.div
              ...
              className="bg-[#FFFFFF] border border-[#E6E6E8] hover:border-[#D2D2D6] transition-all duration-300 rounded-sm p-6 sm:p-10 lg:p-12 shadow-[0_4px_20px_rgba(0,0,0,0.02)]"
            >
              {/* Header Bar */}
        ...
        {selectedStudy && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#FFFFFF] border border-[#E6E6E8] rounded-sm p-6 sm:p-10 shadow-2xl max-h-[90vh] overflow-y-auto"
            >
              <button
                type="button"
                onClick={() => setSelectedStudy(null)}
                className="absolute top-6 right-6 p-2 text-[#7C7D82] hover:text-[#121316] rounded-sm focus:outline-none"
